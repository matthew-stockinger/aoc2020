...
function tripSum2020ToProd(inputArray) {
    for (var i = 0; i < inputArray.length-2; i++) {
        for (var j = 1; j < inputArray.length-1; j++) {
            for (var k = 2; k < inputArray.length; k++) {
                let sum = inputArray[i] + inputArray[j] + inputArray[k];
                if (sum === 2020) {
    ...
    return "no triplet with sum 2020 found.";
}

console.log(tripSum2020ToProd(expenseReport));